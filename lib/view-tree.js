...
function viewTree(document, Component) {
  ...
  return {
    ...
    compose: function compose(components, resolved, params, query) {
      ...
      tree.loadedViews.slice().forEach(function (view) {
        return view.unload();
      });
    }
  };
